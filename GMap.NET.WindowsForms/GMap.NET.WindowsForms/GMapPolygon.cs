...
namespace GMap.NET.WindowsForms
{
...
#endif
   {
	  ...
	  public Pen Stroke1 = new Pen(Color.FromArgb(155, Color.Green));
	  public Pen Stroke2 = new Pen(Color.FromArgb(155, Color.Blue));
	  public Pen Stroke3 = new Pen(Color.FromArgb(155, Color.MidnightBlue));
      ...
      public override void GetObjectData(SerializationInfo info, StreamingContext context)
      {
		 ...
		 info.AddValue("Stroke1", this.Stroke1);
		 info.AddValue("Stroke2", this.Stroke2);
         ...
         : base(info, context)
      {
		 ...
		 this.Stroke1 = Extensions.GetValue<Pen>(info, "Stroke1", new Pen(Color.FromArgb(155, Color.MidnightBlue)));
		 this.Stroke2 = Extensions.GetValue<Pen>(info, "Stroke2", new Pen(Color.FromArgb(155, Color.MidnightBlue)));
