...
namespace GMap.NET.WindowsForms
{
...
#endif
   {
	  ...
	  public Pen Stroke1 = new Pen(Color.FromArgb(144, Color.MidnightBlue));
	  public Pen Stroke2 = new Pen(Color.FromArgb(144, Color.MidnightBlue));
#else
         ...
         : base(info, context)
      {
		 ...
		 this.Stroke1 = Extensions.GetValue<Pen>(info, "Stroke1", new Pen(Color.FromArgb(144, Color.MidnightBlue)));
		 this.Stroke2 = Extensions.GetValue<Pen>(info, "Stroke2", new Pen(Color.FromArgb(144, Color.MidnightBlue)));
